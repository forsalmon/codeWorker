                ...
                <div class="card custom-card mt-0">
                    ...
                    <div class="card-body">
                        <sec:authorize access="hasRole('ROLE_ADMIN')">
                            <form action="/admin/noticeInsert" method="post">
                                ...
                                <div class="card-footer">
                                    <div class="text-end">
                                        ...
                                        <button type="button" class="btn btn-secondary-light" onclick="javascript:location.href='/admin/noticeList'">취소</button>
                                    </div>
                                </div>
                            </form>
                        </sec:authorize>
